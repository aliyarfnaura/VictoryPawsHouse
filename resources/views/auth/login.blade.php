...
<div class="min-h-screen flex flex-col md:flex-row">
    ...
    <div class="md:w-3/5 flex flex-col justify-center items-center p-8 bg-[#AF8F6F]">
        <div class="w-full max-w-md">
            <h1 class="text-4xl md:text-5xl font-extrabold text-[#F8F4E1] mb-10 text-center">LOG IN</h1>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center mt-6 text-gray-700">
                    ...
                    <a class="underline text-[#F8F4E1] hover:text-gray-900 font-bold" href="{{ route('register') }}">
                        Sign Up
                    </a>
                </div>
            </form>
